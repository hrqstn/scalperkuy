...
class PaperTradingConfig(BaseModel):
    ...
    max_feature_gap_seconds: int = 180
    min_quote_count: int = 8
    min_trade_count: int = 40
    min_order_book_count: int = 4
    min_trade_flow_imbalance: float = 0.45
    min_orderbook_imbalance: float = 0.18
    min_volatility_bps: float = 36.0
    min_expected_move_bps: float = 36.0
    cost_buffer_bps: float = 12.0
    min_quality_score: float = 80.0
    dynamic_exit_min_net_bps: float = 4.0
    dynamic_exit_min_adverse_bps: float = 12.0
...
class PaperTradingExperimentConfig(BaseModel):
    ...
    max_feature_gap_seconds: int | None = None
    ...
    min_expected_move_bps: float | None = None
    cost_buffer_bps: float | None = None
    min_quality_score: float | None = None
    dynamic_exit_min_net_bps: float | None = None
    dynamic_exit_min_adverse_bps: float | None = None
